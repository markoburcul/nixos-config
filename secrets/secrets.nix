let
  ...
  luminal  = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIF8+g5e50h7H4k4+xpBt20FxEcveg0EZb+5Q20BixdSX";
  ...
  systems  = [ torvion ghosteye luminal ];
...
in
{
  ...
  "services/nebula/luminal.crt.age"   = { publicKeys = [ markob luminal];   };
  "services/nebula/luminal.key.age"   = { publicKeys = [ markob luminal];   };
